        ...
        <APIProvider apiKey={apiKey}>
          ...
          >
            ...
            {selectedLibrary && (
              ...
              >
                <div className="max-h-[72vh] w-[82vw] max-w-[360px] overflow-y-auto px-0 pb-1 pt-0 text-black sm:max-h-none sm:w-72 sm:overflow-visible">
                  {photoLoading && (
                  ...
                  <div className="mt-3">
                    ...
                    {selectedLibrary.books.length === 0 ? (
                      ...
                      <ul className="mt-2 max-h-64 space-y-2 overflow-y-auto overscroll-contain pr-1 text-sm sm:max-h-32 sm:space-y-1.5">
